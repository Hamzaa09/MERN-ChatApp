...
import { getUserThunk, loginUserThunk } from "../../store/slices/user.thunk";
...
const Login = () => {
  ...
  const { authCheck, buttonLoading } = useSelector(
    ...
    <div className="flex justify-center items-center min-h-screen">
      ...
      <div className="flex flex-col justify-center items-center py-8 border border-[#464E58] rounded-md gap-6 w-[90%] sm:w-[90%] md:w-[60%] lg:w-[40%]">
        ...
        <div className="mt-6 w-[90%]">
          <button
            onClick={handleLogin}
            className="flex justify-center items-center bg-blue-600 text-md font-semibold cursor-pointer hover:opacity-[0.9] active:translate-y-[1px] p-2 w-[100%] rounded-sm text-lg"
          >
            {buttonLoading ? (
