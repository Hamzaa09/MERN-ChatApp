    ...
    <>
      ...
      <div className="flex w-screen h-screen overflow-x-hidden relative">
        <div
          className={
            show
              ? "absolute left-[100%] top-0 w-[100vw] md:w-[40%] md:relative md:left-[0%] md:top-0"
              : "absolute left-[0%] top-0 w-[100vw] md:w-[40%] md:relative md:left-[0%] md:top-0"
          }
        >
        ...
        <div
          className={
            !show
              ? "absolute left-[100%] top-0 w-[100vw] md:w-[full] md:relative md:left-[0%] md:top-0"
              : "absolute left-[0%] top-0 w-[100vw] md:w-[full] md:relative md:left-[0%] md:top-0"
          }
        >
